...
def login():
    ...
    #new code here:
    #this code would take user input and prevent input to interact with raw SQL code
...
#This new code requires that the email being used to register be verified via an email
# def register():
